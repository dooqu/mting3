 ...
 * -----------------------------------------------------------------
 */
public class VisitorSyncDataDialog implements View.OnClickListener {
    ...
    public VisitorSyncDataDialog(@NonNull Context context) {
        builder = new AlertDialog.Builder(context);
        View view = View.inflate(context, R.layout.dialog_visitor_sync_data, null);
