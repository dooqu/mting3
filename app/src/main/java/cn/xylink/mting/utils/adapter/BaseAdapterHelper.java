...
public class BaseAdapterHelper {
    ...
    /**
     * Will set the HTMLtext of a TextView.
     *
     * @param viewId The view id.
     * @param value  The HTMLtext to put in the text view.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setText(int viewId, Spanned value) {
        TextView view = retrieveView(viewId);
        view.setText(value);
        return this;
    }
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setGone(int viewId, boolean visible) {
        View view = retrieveView(viewId);
