...
public class UnreadSpeechList implements SpeechList {
    ...
    static UnreadSpeechList instance;

    public static UnreadSpeechList getInstance() {
        if (instance == null) {
            synchronized (UnreadSpeechList.class) {
                if (instance == null) {
                    instance = new UnreadSpeechList();
                }
            }
        }
        return instance;
    ...
    public UnreadSpeechList() {
        internalList = new LinkedList<>();
        playIterator = internalList.listIterator();
        current = null;
    }

    public UnreadSpeechList(List<Article> articles) {
        internalList = new LinkedList<>(articles);
        playIterator = internalList.listIterator();
        current = null;
    }
