...
public class MultiImageSelector {
    ...
    public MultiImageSelector setVideo(boolean video) {
        isVideo = video;
        return sSelector;
    }
    ...
    public MultiImageSelector selectCount(int count)
    {
        selectCount = count;
        return sSelector;
    }
    ...
    private Intent createIntent(Context context){
        ...
        intent.putExtra(MultiImageSelectorActivity.EXTRA_SELECT_COUNT_IMG,selectCount);
        intent.putExtra(MultiImageSelectorActivity.EXTRA_SHOW_VIDEO,isVideo);
        if(mOriginData != null){
