package cn.xylink.multi_image_selector.image;
...
public class IntensifyImageView extends View implements IntensifyImage,
    ...
    private IntensifyImageAttacher imageAttacher;
    ...
    protected void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        imageAttacher = new IntensifyImageAttacher(this);
        mScroller = new OverScroller(context);
    }

    public void setTouch(boolean isTouch)
    {
        imageAttacher.setTouch(isTouch);
    }
